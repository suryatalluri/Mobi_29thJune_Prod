 ...
 * @see Table1
 */
@Service("test_notables.Table1Service")
public class Table1ServiceImpl implements Table1Service {
    ...
    @Autowired
    @Qualifier("test_notables.Table1Dao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service test_notables for table Table1 to {} format", exportType);
