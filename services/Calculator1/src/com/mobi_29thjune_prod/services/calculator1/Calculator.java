 ...
 * 2017-07-25T10:12:43.852Z
 * Generated source version: 2.7.11
 * 
 */
@WebServiceClient(name = "Calculator", 
                  wsdlLocation = "Calculator1.wsdl",
...
public class Calculator extends Service {
    ...
    static {
        URL url = Calculator.class.getResource("Calculator1.wsdl");
        if (url == null) {
            url = Calculator.class.getClassLoader().getResource("Calculator1.wsdl");
        } 
        if (url == null) {
            java.util.logging.Logger.getLogger(Calculator.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "Calculator1.wsdl");
        }       
        WSDL_LOCATION = url;
    }
